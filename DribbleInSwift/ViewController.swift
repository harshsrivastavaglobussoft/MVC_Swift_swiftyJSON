...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView==self.PopularTableView {
            var dataModel:swiftyJSONModel!
            dataModel = self.PopualarDataArray[indexPath.row] as! swiftyJSONModel
            ...
            var dataModel:swiftyJSONModel!
            dataModel = self.TimeDataArray[indexPath.row] as! swiftyJSONModel
            ...
            var dataModel:swiftyJSONModel!
            dataModel = self.ReboundDataArray[indexPath.row] as! swiftyJSONModel
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if tableView==self.PopularTableView {
            let selectedData = self.PopualarDataArray .object(at: indexPath.row)as! swiftyJSONModel
            ...
            let selectedData = self.ReboundDataArray .object(at: indexPath.row)as! swiftyJSONModel
            
            let imageUrlString = selectedData.hidpi
            
            imageUrl = URL.init(string: imageUrlString! as String)
        }else{
            let selectedData = self.TimeDataArray .object(at: indexPath.row)as! swiftyJSONModel
